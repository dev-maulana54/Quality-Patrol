        ...
        <div id="mainContent" class="pb-20" style="min-height: calc(100% - 140px);"><!-- Dashboard Page -->
            ...
            <div id="dataPatrolPage" class="page-content">
                <div class="px-4 py-4">
                    ...
                    <div id="AuditeeTab" class="tab-content hidden">
                        <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex items-start justify-between mb-3">
                                    <div class="flex-1">
                                        ...
                                        <h3 class="text-base font-bold text-dark mb-2">
                                            Kebersihan area kurang
                                        </h3>
                                        <div class="space-y-1">
                                            <p class="text-sm text-gray">
                                                <i class="fas fa-map-marker-alt w-4"></i> Warehouse
                                            </p>
                                            <p class="text-sm text-gray">
                                                <i class="fas fa-user-tie w-4"></i> Ahmad S.
                                            </p>
                                        </div>
                                    </div>
                                    <span class="status-badge status-open">Open</span>
                            ...
                            <div class="card-bg rounded-xl p-4 shadow-md">
                                <div class="flex items-start justify-between mb-3">
                                    <div class="flex-1">
                                        ...
                                        <div class="space-y-1">
                                            <p class="text-sm text-gray">
                                                <i class="fas fa-map-marker-alt w-4"></i> Production
                                            </p>
                                            <p class="text-sm text-gray">
                                                <i class="fas fa-user-tie w-4"></i> Budi T.
                                            </p>
                                        </div>
                                    </div>
        ...
        function showDetail(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.detail_area_section').text(response.temuan.section);
      ...
      `;
        ...
        $(function() {
            $(".tab-btn").on("click", function() {
                ...
                $("#AuditorTab, #AuditeeTab, #attendanceDataTab").hide();

                // tampilkan tab yang dipilih
                $("#" + tabName + "Tab").show();

                // ===== FAB tampil hanya di tab Auditor =====
                if (tabName === "Auditor") {
                    $(".btnTambahPatrol").attr("style", "display: flex !important;");
                } else {
                    $(".btnTambahPatrol").attr("style", "display: none !important;"); // sembunyikan tombol
                }
            });
        });
