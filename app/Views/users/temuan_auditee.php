...
<body class="light-theme"><!-- Header -->
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu-item has-submenu open">
            ...
            <div class="submenu">
                ...
                <a href="<?= base_url('temuan_patrol/auditee') ?>" class="submenu-item active">
        ...
        <div class="table-card mt-2">
            ...
            <div class="table-responsive mt-3">
                ...
                <table id="auditTable" class="table table-striped table-hover" style=" font-size: 13px;">
                    ...
                    <tbody>
                        <?php foreach ($data_patrol_auditee as $index => $patrol) : ?>
                            <tr>
                                <td><?= $index + 1 ?></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group mt-2">
                            <label for="auditorName" class="form-label">
                                <i class="bi bi-journal-text me-1"></i> Deskripsi Temuan
                            </label> <small> <i>Di isi oleh Auditor !!!</i></small>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <select class="tomselect" id="fill_pic_action" style="width:100%;" disabled>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" class="form-control " id="fill_due_date" placeholder="Pilih tanggal audit" required disabled>
                        ...
                        <div class="form-group mt-2" id="row_keterangan_cancel2" style="display: none;">
                            ...
                            <textarea class="form-control" placeholder="Leave a comment here" id="keterangan_cancel2" disabled></textarea>
  ...
  `);
        ...
        // contoh pemakaian: setelah modal tampil
        $('#modal_fillData').on('shown.bs.modal', function() {

            attachAirDatepickerResponsive('fill_due_date');
        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.temuan.status_temuan == 1) {
                        ...
                        $('#fill_pic_action').attr('disabled', true);
                        $('#fill_due_date').attr('disabled', true);
                    ...
                    if (id_section_user == response.temuan.id_section || id_dept_user == response.temuan.id_departement) {
                        ...
                        if (response.temuan.status_temuan == 1) {
                            $('#fill_analisa_penyebab').prop('disabled', true);
                            $('#fill_action').prop('disabled', true);
                            $('#fill_pic_action').prop('disabled', true);
                            $('#fill_due_date').prop('disabled', true);
                    ...
                    // console.log('id section temuan', response.temuan.id_section);
